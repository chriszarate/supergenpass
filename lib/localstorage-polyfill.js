...
/* Polyfill in closure to avoid pollution. */
...
(function() {
  ...
  if(!LocalStorage || !SessionStorage) {
    ...
    */
    ...
    try {
      if(!LocalStorage) {
        window.LocalStorage = window.localStorage = new Storage('local');
      }
    } catch(e) {
    ...
    try {
      if(!SessionStorage) {
        window.SessionStorage = window.sessionStorage = new Storage('session');
      }
    } catch(e) {
